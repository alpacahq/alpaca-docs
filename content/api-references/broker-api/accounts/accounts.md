...
| `context`                         | object                                                       | {{<hint info>}}Optional {{</hint>}}   | Information relevant to the user's disclosure selection should be sent through this object.                                                                           |
...
| `company_state`            | string                                             | {{<hint info>}}Optional {{</hint>}}                                                             | Required if `company_country = USA` |
