...
| `SENT_TO_CLEARING` | Journal sent to be processed.                                                                                       |
| `PENDING`          | Journal accepted but pending execution. This is the default status for all journals in `POST/v1/journals` requests. |
