...
| `filed_at`         | string/timestamp | Can be `null`                                                                                                                                                                     |
...
| `type`            | string/numeric | {{<hint danger>}}Required {{</hint>}} | `market`, `limit`, `stop`, `stop_limit`, or `trailing_stop`                                                                                        |
| `time_in_force`   | string         | {{<hint danger>}}Required {{</hint>}} | `day`, `gtc`, `opg`, `cls`, `ioc`, `fok`. Please see Understand Orders for more info.                                                              |
| `limit_price`     | string/numeric | {{<hint info>}}Optional {{</hint>}}   | {{<hint danger>}}Required {{</hint>}} If type is `limit` or `stop_limit`                                                                           |
| `stop_price`      | string         | {{<hint info>}}Optional {{</hint>}}   | {{<hint danger>}}Required {{</hint>}} If type is `stop` or `stop_limit`                                                                            |
| `trail_price`     | string         | {{<hint info>}}Optional {{</hint>}}   | {{<hint danger>}}Required {{</hint>}} If type is `trailing_stop`, `trail_price` or `trail_percent` is required                                     |
| `trail_percent`   | string         | {{<hint info>}}Optional {{</hint>}}   | {{<hint danger>}}Required {{</hint>}} If type is `trailing_stop`, `trail_price` or `trail_percent` is required                                     |
...
| `client_order_id` | string         | {{<hint info>}}Optional {{</hint>}}   | A unique identifier for the order. Automatically generated if not sent. (<= 48 characters)                                                         |
...
| `take_profit`     | string         | {{<hint info>}}Optional {{</hint>}}   | Additional parameters for take-profit leg of advanced orders                                                                                       |
| `stop_loss`       | string/numeric | {{<hint info>}}Optional {{</hint>}}   | Additional parameters for stop-loss leg of advanced orders                                                                                         |
| `commission`      | number         | {{<hint info>}}Optional {{</hint>}}   | The commission you want to collect from the user.                                                                                                  |
